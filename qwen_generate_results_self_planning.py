...
def get_plan_then_code(task_prompt, model="qwen-turbo"):  # or "qwen-plus", "qwen-turbo"
    ...
    plan_prompt = f"""You are an expert Python programmer.
...
{task_prompt}"""
    ...
    code_prompt = f"""Using the PLAN below, output ONLY the final function definition. Label the section "CODE:" and put the code after it.
...
with open("qwen_results_self_planning.jsonl", "w") as f:
    for r in results:
